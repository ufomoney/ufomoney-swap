...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    primary1: darkMode ? '#2172E5' : '#2c77d9',
    primary2: darkMode ? '#3680E7' : '#e5e7fe',
    primary3: darkMode ? '#4D8FEA' : '#c43b44',
    primary4: darkMode ? '#376bad70' : '#e5e7fe',
    primary5: darkMode ? '#153d6f70' : '#e5e7fe',

    // color text
    primaryText1: darkMode ? '#6da8ff' : '#2c77d9',

    // secondary colors
    secondary1: darkMode ? '#2172E5' : '#2c77d9',
    secondary2: darkMode ? '#17000b26' : '#e5e7fe',
    secondary3: darkMode ? '#17000b26' : '#e5e7fe',
